  ...
  return (
    <Link
      ...
      className={cn(
        ...
        "hover:before:origin-left hover:before:scale-x-100 focus-visible:before:origin-left focus-visible:before:scale-x-100 motion-reduce:before:transition-none",
      )}
    >
      {children}
    </Link>
